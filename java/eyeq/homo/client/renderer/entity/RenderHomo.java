...
public class RenderHomo extends RenderLiving {
    protected static final ResourceLocation textures = new EntityRenderResourceLocation(MOD_ID, "homo");

    private static float scale = 1.6F;

    public RenderHomo(RenderManager renderManager) {
